...
function SeoPolicy() {
  ...
  return (
    <div className='h-full'>
      <form action='' className='flex h-full flex-col gap-4 xl:flex-row xl:items-start' onSubmit={(e) => e.preventDefault()}>
        ...
        <div className='w-full space-y-6 sm:space-y-10'>
          ...
          <div className='flex flex-wrap justify-end gap-3 sm:gap-4'>
            <button type='button' onClick={() => notify('Policy document saved.', 'success')} className='w-full rounded-sm border border-white-color/20 bg-[#2DCA95] px-4 py-2.5 text-center text-sm font-inter-m sm:w-[100px]'>
              Save
            </button>
