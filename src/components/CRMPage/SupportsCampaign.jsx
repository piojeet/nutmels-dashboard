...
function SupportsCampaign() {
  return (
    <div className='flex gap-4 2xl:flex-row'>
      <div className='shrink-0 rounded-xl border border-white-color/20 bg-white-color/10 2xl:max-w-[450px] flex-1'>
        <div>
      ...
      <div className='w-full rounded-xl border border-white-color/20 bg-white-color/10'>
        <div className='px-3'>
          <div className='block'>
            <div className='flex flex-col gap-4 border-b border-white-color/30 py-3 sm:flex-row sm:items-center sm:justify-between'>
            ...
            <div className='h-[300px] overflow-y-auto pt-3'>
              <div>
                <div className='w-full max-w-[350px] rounded-lg bg-white-color/10 p-3 text-sm'>
                  <p>Hello, I want to make enquiries about your product</p>
                </div>
                <div className='mt-0.5 font-inter-r font-medium text-white-color/30 text-xs'>12:55 am</div>
              </div>
              <div className='flex flex-col items-end justify-end'>
                <div className='w-full max-w-[350px] rounded-lg bg-white-color p-3 text-black-color text-sm'>
                  <p>Hello, I want to make enquiries about your product</p>
                </div>
                <div className='mt-0.5 flex items-center gap-2 font-inter-r font-medium text-white-color/30 text-xs'>
          ...
          <div className='mb-3 mt-3 flex flex-col gap-4 rounded-xl border border-white-color/20 bg-white-color/10 p-3 sm:flex-row sm:items-center sm:justify-between'>
            ...
            <div className='flex items-center justify-end gap-2'>
              ...
              <button className='flex h-[35px] w-[35px] items-center justify-center rounded-lg bg-yellow-color'>
