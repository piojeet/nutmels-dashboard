...
const statuses = ['Customer Profile', 'Funnel', 'Supports & Campaign', 'Rating & Review'];
                        ...
                        <table className='w-full'>
                            <thead className='text-white-color bg-white-color/10 rounded-t-md text-sm font-proxima-r'>
                                <tr>
                                    ...
                                    <th><span className='px-2 py-2 inline-block'>Customer Name</span></th>
                                    <th><span className='px-2 py-2 inline-block'>Phone Number</span></th>
                                    <th><span className='px-2 py-2 inline-block'>Email Id</span></th>
                                    <th><span className='px-2 py-2 inline-block'>Date of Birth</span></th>
                                    <th><span className='px-2 py-2 inline-block'>Patronage</span></th>
                                    ...
                                    <tr key={order.id} className='px-4 py-3 text-white-color border-b border-white/10 text-sm'>
                                        <td className='text-center'>
                                            <span className='px-2 py-2 flex w-fit mx-auto items-center'>
                                                ...
                                                <span className='px-2 py-2 inline-block font-proxima-r'>{order.customerId}</span>
                                            </span>
                                        </td>
                                        <td className='text-center'><span className='px-2 py-2 inline-block font-proxima-r'>{order.customerName}</span></td>
                                        <td className='text-center'><span className='px-2 py-2 inline-block font-proxima-r'>+91 {order.phoneNum}</span></td>
                                        <td className='text-center'><span className='px-2 py-2 inline-block font-proxima-r'>{order.emailId}</span></td>
                                        <td className='text-center'>
                                        ...
                                        <td className='text-center'>
                                            <span className='px-2 py-3 inline-block font-proxima-r'>
                                                <span className={`px-2 py-1 rounded-md text-[10px] font-medium font-inter-m ${order.patronage === 'First Timer' ? 'bg-green-200 text-green-700' : 'bg-red-200 text-red-700'}`}>
                                                    {order.patronage}
                                                </span>
                                            </span>
                                        </td>
                                        <td>
                                            <span className='flex items-center justify-center gap-4 px-2 py-2'>
                                                ...
                                                <button><BsChat className='cursor-pointer opacity-70 hover:opacity-100 transition' /></button>
                                            </span>
                                        </td>
                                    </tr>
                                ))}
