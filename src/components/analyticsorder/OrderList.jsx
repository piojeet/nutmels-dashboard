...
function OrderList() {
  ...
  return (
    <div ref={containerRef} className='rounded-xl border border-white-color/20 bg-white-color/5'>
      ...
      <div className='max-h-[261px] overflow-auto [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-yellow-color [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-white-color/20 [&::-webkit-scrollbar]:w-1'>
