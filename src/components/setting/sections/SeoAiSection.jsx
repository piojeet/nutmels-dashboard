...
function SeoAiSection() {
  ...
  return (
    <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_1fr]">
      <div className="rounded-xl border border-[#e8edf4]/20 p-4 text-[#ebebeb] shadow-sm">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-yellow-color text-yellow-color">
              <FiCode />
            </span>
        ...
        <textarea
          ...
          className="mt-4 min-h-[100px] w-full resize-none rounded-lg bg-[#f8f9fb1c] p-3 font-mono text-sm leading-6 text-[#cfd3e2] outline-none ring-1 ring-transparent transition focus:ring-[#101f8e]/20"
        />
        ...
        <div className="mt-3 flex justify-end">
          <button
            ...
            className="inline-flex h-9 items-center justify-center gap-2 rounded-lg bg-yellow-color px-5 text-sm font-inter-b text-white transition hover:brightness-110"
          >
            <FiSave />
            Save Changes
          </button>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-[#e8edf4]/20 p-4 text-[#1A1A1A] shadow-sm">
        ...
        <div className="rounded-xl border border-yellow-color/30 p-4 text-white shadow-sm">
      ...
      <div className="rounded-xl border border-[#e8edf4]/20 p-4 text-[#1A1A1A] shadow-sm xl:col-span-2">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex gap-3">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-yellow-color text-xl text-yellow-color">
              <FiGitMerge />
            </span>
            <div>
              <h2 className="text-xl font-inter-b text-yellow-color">Schema.org Enrichment</h2>
              <p className="text-xs text-[#cdced3]">
        ...
        <div className="mt-3">
          <div className="grid gap-3 grid-cols-2">
            <label className="grid gap-2 grid-cols-1">
              ...
              <input
                ...
                className="h-[35px] w-full rounded-lg border border-white-color/14 bg-white-color/[3%] px-4 text-sm! text-white-color outline-none transition placeholder:text-white-color/25 focus:border-yellow-color/40 focus:bg-white-color/[6%]"
              />
            </label>
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:ml-auto lg:max-w-[400px]">
          <button
            ...
            className="h-9 rounded-lg border border-yellow-color text-sm font-inter-b text-yellow-color transition hover:bg-yellow-color hover:text-white"
          >
            Discard
          </button>
          <button
            ...
            className="h-9 rounded-lg bg-yellow-color text-sm font-inter-b text-white transition hover:brightness-110 cursor-pointer"
          >
            Sync Schema
          </button>
        </div>
