  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        <FieldShell label="Media storage" className="">
          <SelectInput
            value={form.storage}
        ...
        <FieldShell label="Thumb prefix" className="">
          <TextInput
        ...
        <FieldShell label="Default image" className="">
          <TextInput
        ...
        <FieldShell label="CDN URL" className="">
          <TextInput
            icon={FiGlobe}
            value={form.cdnUrl}
        ...
        <FieldShell label="Google cloud project ID" className="">
          <TextInput
        ...
        <FieldShell label="Google cloud storage bucket" className="">
          <TextInput
            value={form.bucket}
        ...
        <FieldShell label="Google cloud storage path prefix" className="">
          <TextInput
