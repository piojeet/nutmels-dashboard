    ...
    <section>
      <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
        ...
        <div className='flex w-full flex-col gap-2 sm:w-auto sm:flex-row'>
          ...
          <button className='rounded-md bg-yellow-color px-4 py-2 text-sm font-medium text-black-color'>
            Download
          </button>
        </div>
      </div>
        ...
        {reports.map((name, i) => (
          ...
          >
            ...
            <div className='flex items-center justify-start sm:justify-center'>
              <button className='flex items-center justify-center text-white-color/60'>
                <FiDownload />
              </button>
            </div>
          </div>
